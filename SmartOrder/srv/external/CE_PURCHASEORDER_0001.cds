/* checksum : d7dddc2f973d678c8d9956c3c30bf282 */
@cds.external : true
...
entity CE_PURCHASEORDER_0001.POSubcontractingComponent {
  ...
  _PurchaseOrder : Association to one CE_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrder.PurchaseOrder = PurchaseOrder;
  _PurchaseOrderItem : Association to one CE_PURCHASEORDER_0001.PurchaseOrderItem {  };
  _ScheduleLine : Association to one CE_PURCHASEORDER_0001.PurchaseOrderScheduleLine on _ScheduleLine.ScheduleLine = ScheduleLine;
};
...
entity CE_PURCHASEORDER_0001.PurchaseOrder {
  ...
  _PurchaseOrderItem : Composition of many CE_PURCHASEORDER_0001.PurchaseOrderItem on _PurchaseOrderItem._PurchaseOrder = $self;
  @Common.Composition : true
  _PurchaseOrderNote : Composition of many CE_PURCHASEORDER_0001.PurchaseOrderNote on _PurchaseOrderNote._PurchaseOrder = $self;
  @Common.Composition : true
  _PurchaseOrderPartner : Composition of many CE_PURCHASEORDER_0001.PurchaseOrderPartner on _PurchaseOrderPartner._PurchaseOrderTP = $self;
  @Common.Composition : true
  _SupplierAddress : Composition of one CE_PURCHASEORDER_0001.PurchaseOrderSupplierAddress on _SupplierAddress._PurchaseOrderTP = $self;
} actions {
  function GetOutputBinaryData() returns CE_PURCHASEORDER_0001.D_PurOrdGetOutputBinaryDataR not null;
};
...
entity CE_PURCHASEORDER_0001.PurchaseOrderAccountAssignment {
  ...
  SAP__Messages : many CE_PURCHASEORDER_0001.SAP__Message not null;
  _PurchaseOrder : Association to one CE_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrder.PurchaseOrder = PurchaseOrder;
  _PurchaseOrderItem : Association to one CE_PURCHASEORDER_0001.PurchaseOrderItem on _PurchaseOrderItem.PurchaseOrderItem = PurchaseOrderItem;
};
...
entity CE_PURCHASEORDER_0001.PurchaseOrderInvoicingPlan {
  ...
  SAP__Messages : many CE_PURCHASEORDER_0001.SAP__Message not null;
  @Common.Composition : true
  _POInvoicingPlanItem : Composition of many CE_PURCHASEORDER_0001.PurchaseOrderInvoicingPlanItem on _POInvoicingPlanItem._PurchaseOrderInvoicingPlan = $self;
  _PurchaseOrder : Association to one CE_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrder.PurchaseOrder = PurchaseOrder;
  _PurchaseOrderItem : Association to one CE_PURCHASEORDER_0001.PurchaseOrderItem on _PurchaseOrderItem.PurchaseOrderItem = PurchaseOrderItem;
};
...
entity CE_PURCHASEORDER_0001.PurchaseOrderInvoicingPlanItem {
  ...
  SAP__Messages : many CE_PURCHASEORDER_0001.SAP__Message not null;
  _PurchaseOrder : Association to one CE_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrder.PurchaseOrder = PurchaseOrder;
  _PurchaseOrderInvoicingPlan : Association to one CE_PURCHASEORDER_0001.PurchaseOrderInvoicingPlan on _PurchaseOrderInvoicingPlan.InvoicingPlan = InvoicingPlan;
  _PurchaseOrderItem : Association to one CE_PURCHASEORDER_0001.PurchaseOrderItem {  };
};
...
entity CE_PURCHASEORDER_0001.PurchaseOrderItem {
  ...
  SAP__Messages : many CE_PURCHASEORDER_0001.SAP__Message not null;
  @Common.Composition : true
  _DeliveryAddress : Composition of one CE_PURCHASEORDER_0001.PurOrderItemDeliveryAddress on _DeliveryAddress._PurchaseOrderItem = $self;
  _PurchaseOrder : Association to one CE_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrder.PurchaseOrder = PurchaseOrder;
  @Common.Composition : true
  @Validation.MaxItems : 1
  _PurchaseOrderInvoicingPlan : Composition of many CE_PURCHASEORDER_0001.PurchaseOrderInvoicingPlan on _PurchaseOrderInvoicingPlan._PurchaseOrderItem = $self;
  @Common.Composition : true
  _PurchaseOrderItemNote : Composition of many CE_PURCHASEORDER_0001.PurchaseOrderItemNote on _PurchaseOrderItemNote._PurchaseOrderItem = $self;
  @Common.Composition : true
  _PurchaseOrderScheduleLineTP : Composition of many CE_PURCHASEORDER_0001.PurchaseOrderScheduleLine on _PurchaseOrderScheduleLineTP._PurchaseOrderItem = $self;
  @Common.Composition : true
  _PurOrdAccountAssignment : Composition of many CE_PURCHASEORDER_0001.PurchaseOrderAccountAssignment on _PurOrdAccountAssignment._PurchaseOrderItem = $self;
  @Common.Composition : true
  _PurOrdPricingElement : Composition of many CE_PURCHASEORDER_0001.PurOrderItemPricingElement on _PurOrdPricingElement._PurchaseOrderItem = $self;
};
...
entity CE_PURCHASEORDER_0001.PurchaseOrderPartner {
  ...
  _PurchaseOrderTP : Association to one CE_PURCHASEORDER_0001.PurchaseOrder on _PurchaseOrderTP.PurchaseOrder = PurchaseOrder;
};
...
entity CE_PURCHASEORDER_0001.PurchaseOrderScheduleLine {
  ...
  _PurchaseOrderItem : Association to one CE_PURCHASEORDER_0001.PurchaseOrderItem on _PurchaseOrderItem.PurchaseOrderItem = PurchaseOrderItem;
  @Common.Composition : true
  _SubcontractingComponent : Composition of many CE_PURCHASEORDER_0001.POSubcontractingComponent on _SubcontractingComponent._ScheduleLine = $self;
};
